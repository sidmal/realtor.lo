...
class CallCardTest extends WebTestCase
{
    public function testCallCardActivate()
    {
        ...
        $call = new Call();
        $call->setLinkedId('7898a25afe246f2e2620394e50622a7e')->setInternalId($uniqueId)->setAtsCallId($uniqueId)
            ->setType(1)->setFromPhone('9213839207')->setToPhone('205')->setCallAction('connect-exten')
    ...
    public function testDialExten()
    {
        ...
        $call->setLinkedId($uniqueId)->setInternalId($uniqueId)->setAtsCallId($uniqueId)
            ->setType(1)->setFromPhone('9213839207')->setToPhone('205')->setCallAction('dial-exten')
            ->setEventAt(new \DateTime());
